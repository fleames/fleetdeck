...
func main() {
	...
	worker.New(pool, hub, cfg.AgentOfflineAfter, cfg.RawRetentionDays, cfg.Agg5mRetentionDays, cfg.Agg1hRetentionDays, cfg.AlertWebhookURL, srv.Secrets()).Start(ctx)
